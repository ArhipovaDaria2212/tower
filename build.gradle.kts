...
allprojects {
	...
	val jsonwebtoken: String by project
	...
	dependencyManagement {
		dependencies {
			...
			dependency("io.jsonwebtoken:jjwt-api:$jsonwebtoken")
			dependency("io.jsonwebtoken:jjwt-impl:$jsonwebtoken")
			dependency("io.jsonwebtoken:jjwt-jackson:$jsonwebtoken")
